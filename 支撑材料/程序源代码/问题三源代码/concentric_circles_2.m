function [points, nums, circle_r, point_num, group] = concentric_circles_2(center, circle_num, min_r, dist)
    % 按最密排列的方法，以center为中心生成同心圆，生成圆上的点的坐标
    % 输入参数:
    % center: 圆心坐标 [x, y]
    % n: 同心圆的数量
    % r: 最小的圆半径
    ...
    for i = 1:circle_num
        ...
        num_points = floor(circumference / dist(i));  % 当前圆上可以放置的点的数量
