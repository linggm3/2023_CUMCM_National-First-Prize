function [sum_energy, unit_energy, avg_eta] = val_func_2(install_heights, heights, widths, circle_num, min_r, dist, collector_tower)

    % 评价函数
    positions = concentric_circles_2(collector_tower, circle_num, min_r, dist);
